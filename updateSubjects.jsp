...
<%
    ...
    try {
        ...
        // Load faculty list
        facStmt = conn.prepareStatement("SELECT faculty_id, faculty_name FROM faculty");
...
<h2 style="text-align:center;">Update Subjects</h2>
<table>
    <tr>
        <th>Subject ID</th>
        <th>Subject Name</th>
            ...
            <td>
                <select name="faculty">
                    ...
                    <% for (String[] faculty : facultyList) {
                        ...
                        String optionText = faculty[0] + " - " + faculty[1];
